...
const timeline = [
  ...
  },
  {
    ...
    date: "2024 – Ongoing",
    description:
      "Created a student platform for sharing resources and results.",
    icon: "📄",
  },
  {
    title: "GenAI Hackathon 2025 – AI Hajipur",
    date: "2025",
    description:
      "Participated in a one-day immersive GenAI hackathon powered by Google for Developers. Built an EduTech-focused AI Agent prototype using modern Generative AI tools.",
    icon: "🤖",
  },
];
...
const Experience = () => {
  return (
    <div
      id="Experience"
      className="flex flex-col py-20 justify-center items-center bg-white"
    >
      {/* Heading */}
      <div
      ...
      <section id="resume" className="w-full max-w-4xl px-4">
        ...
        <div className="mt-10 text-center">
          <a
            href="https://drive.google.com/uc?export=download&id=1Ix9GPLsCzCUZvnOSSvZBYgR5O1qCyC-9"

...
const About = () => {
  return (
    <div className="md:min-h-[100vh] flex justify-center items-center flex-col mdflex-col ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 justify-between w-[90vw] md:w-[80vw] mx-auto md:gap-9">
          ...
          <div className="text-base md:text-lg">
            ...
            <div className="bg-black group text-white px-5 py-3 w-fit font-semibold text-xl mb-3 rounded-md hover:text-black hover:bg-white hover:border-2 hover:border-black cursor-pointer shadow-lg transform transition duration-300 hover:shadow-2xl animate-pulse mx-auto">

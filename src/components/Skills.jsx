...
const Skills = () => {
  return (
   ...
   {SkillTopic.map((skill, index) => {
    return (
      <div key={index} className="flex flex-row gap-6 md:items-center w-[90vw] md:w-[80vw] mx-auto py-6">
        <div className="capitalize text-xl font-bold w-fit">{skill.topic}: </div>
